<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Subtítulo -->
            <div class="mb-6">
                <p class="text-gray-600">Panel de control para coordinadores</p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        <div class="mt-2 w-full bg-gray-200 rounded-full h-1">
                            <div class="bg-green-500 h-1 rounded-full" style="width: {{ ($estadisticas['a_tiempo']/$estadisticas['total'])*100 }}%"></div>
                        </div>
                        @endif
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        @if($estadisticas['total'] > 0)
                        <div class="mt-2 w-full bg-gray-200 rounded-full h-1">
                            <div class="bg-yellow-500 h-1 rounded-full" style="width: {{ ($estadisticas['tardanzas']/$estadisticas['total'])*100 }}%"></div>
                        </div>
                        @endif
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        @if($estadisticas['total'] > 0)
                        <div class="mt-2 w-full bg-gray-200 rounded-full h-1">
                            <div class="bg-red-500 h-1 rounded-full" style="width: {{ ($estadisticas['faltas']/$estadisticas['total'])*100 }}%"></div>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <form method="GET" action="{{ route('asistencias.consulta-coordinador') }}">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select name="id_docente" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="flex gap-2 mt-4">
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-150">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                                </svg>
                                Buscar
                            </button>
                            <a href="{{ route('asistencias.consulta-coordinador') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition duration-150">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <svg class="inline w-4 h-4 text-gray-400 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
