                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Horas/Semana</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Días</th>
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-600">
                                            {{ $materia->es_electiva ? '3h' : '4h 30min' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
