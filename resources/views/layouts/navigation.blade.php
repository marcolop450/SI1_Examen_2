        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                        <img src="{{ asset('images/logo-ficct.png') }}" alt="Logo FICCT" class="h-10 w-auto">
                        <span class="text-xl font-bold text-blue-600 hidden sm:block">FICCT</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:text-gray-900 focus:outline-none transition ease-in-out duration-150 shadow-sm">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('profile.edit')" class="flex items-center hover:bg-blue-50 transition-colors">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                    ...
                                    class="flex items-center hover:bg-red-50 text-red-600 transition-colors">
